...
-- AddForeignKey
ALTER TABLE "GenerationRecord" ADD CONSTRAINT "GenerationRecord_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "ProductProject"("id") ON DELETE CASCADE ON UPDATE CASCADE;
