  ...
  if (projects.length === 0) {
    return (
      <Card className="relative overflow-hidden border-dashed">
        <div aria-hidden className="absolute inset-0 bg-gradient-to-br from-primary/[0.02] to-emerald-500/[0.02]" />
        <CardContent className="flex flex-col items-center justify-center text-center py-16 relative">
          <div className="relative mb-6">
            <div className="size-16 rounded-2xl bg-gradient-to-br from-primary/10 to-violet-500/10 ring-1 ring-primary/20 flex items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button render={<Link href="/dashboard/new" />} className="gap-2">
